...
We are next going to pull in the animal track for this animal and perform some filtering. We will run the Douglas-argos filter and the Freitas filter on the argos data, and a basic GPS filter on our GPS data.
...
FF_data <- freitas.filter(Argos_data, vmax = 3, ang = c(15, 25), distlim = c(2.5, 5))$retained
