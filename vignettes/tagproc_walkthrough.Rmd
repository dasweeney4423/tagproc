...
Greg, make sure to run this first line of code below to pull in these functions to your workspace. Make sure the file path is correct for where you put the .Rdata I gave you.

```{r}
#load("C:/Users/marec/Docs/tagproc_tools.RData")
```
