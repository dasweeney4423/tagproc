...
As mentioned above, we can also plot the animal track on a map after converting our data to a spatial object. Additionally, we can calculate a home range estimates and add them to the map.
